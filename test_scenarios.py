...
def run_validation_scenarios() -> None:
    ...
    print_validation_row("T1 Normal Reception", "ACCEPT", result1)
    ...
    print_validation_row("T2 Message Tampering", "REJECT", result2)
    ...
    print_validation_row("T3 Token Mismatch", "REJECT", result3)
    ...
    print_validation_row("T4 Metadata Mismatch / Wrong Receiver", "REJECT", result4)
    ...
    print_validation_row("T5 Replay First Attempt", "ACCEPT", first_result)
    print_validation_row("T5 Replay Second Attempt", "REJECT", second_result)
